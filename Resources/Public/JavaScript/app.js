...
(function() {
  var TYPO3, convertToSimpleObject, javaScript, stylesheet, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
  ...
  if (!TYPO3.FormBuilder.Configuration.applicationName) {
    TYPO3.FormBuilder.Configuration.applicationName = 'Form Builder';
  }
  ...
  TYPO3.FormBuilder.Model.Renderable = Ember.Object.extend({
    ...
    setPathRecursively: function(path, v) {
      ...
      return currentObject.set(path, v);
    },
    ...
    arrayWillChange: function(subArray, startIndex, removeCount, addCount) {
      var i, _k, _ref6, _results;
      _results = [];
      for (i = _k = startIndex, _ref6 = startIndex + removeCount; startIndex <= _ref6 ? _k < _ref6 : _k > _ref6; i = startIndex <= _ref6 ? ++_k : --_k) {
    ...
    arrayDidChange: function(subArray, startIndex, removeCount, addCount) {
      var i, _k, _ref6;
      for (i = _k = startIndex, _ref6 = startIndex + addCount; startIndex <= _ref6 ? _k < _ref6 : _k > _ref6; i = startIndex <= _ref6 ? ++_k : --_k) {
  ...
  TYPO3.FormBuilder.View.ContainerView = Ember.ContainerView.extend({
    ...
    onInstanciatedViewsChange: (function() {
      ...
      _ref6 = this.get('instanciatedViews');
      _results = [];
  ...
  TYPO3.FormBuilder.View.Application = Ember.View.extend({
    ...
    updatePageTitle: (function() {
      return document.title = Ember.getPath('TYPO3.FormBuilder.Configuration.applicationName') + ' - ' + Ember.getPath('TYPO3.FormBuilder.Model.Form.formDefinition.label');
  ...
  TYPO3.FormBuilder.View.Header.PresetSelector = Ember.Select.extend({
    ...
    resetSelection: (function() {
      var val, _k, _len2, _ref6, _results;
      if (!this.get('content')) {
        return;
      }
      _ref6 = this.get('content');
      _results = [];
      for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
        val = _ref6[_k];
    ...
    saveAndRedirect: function() {
      return TYPO3.FormBuilder.Model.Form.save((function(_this) {
  ...
  TYPO3.FormBuilder.View.Stage = Ember.View.extend({
    ...
    findRenderableForPath: function(path) {
      ...
      for (_k = 0, _len2 = expandedPathToClickedElement.length; _k < _len2; _k++) {
        pathPart = expandedPathToClickedElement[_k];
        _ref6 = currentRenderable.get('renderables');
  ...
  TYPO3.FormBuilder.View.StructurePanel = Ember.View.extend({
    ...
    updateTree: (function() {
      var activeNodePath, expandedNodePath, expandedNodePaths, _base, _base1, _k, _len2, _ref6, _ref7, _ref8;
      if (!((_ref6 = this._tree) != null ? _ref6.dynatree('getTree').visit : void 0)) {
        return;
      }
      expandedNodePaths = [];
      ...
      for (_k = 0, _len2 = expandedNodePaths.length; _k < _len2; _k++) {
    ...
    updateTreeStateFromModel: function(dynaTreeParentNode, currentListOfSubRenderables, expandFirstNode) {
      var i, newNode, nodeOptions, subRenderable, _k, _len2, _results;
      ...
      _results = [];
      for (i = _k = 0, _len2 = currentListOfSubRenderables.length; _k < _len2; i = ++_k) {
    ...
    getNextFreeIdentifier: function() {
      ...
      isIdentifierUsed = function(identifier) {
        ...
        checkIdentifier = function(renderable) {
          var childRenderable, _k, _len2, _ref6, _results;
          if (renderable.get('identifier') === identifier) {
            identifierFound = true;
          }
          if (!identifierFound) {
            _ref6 = renderable.get('renderables');
            _results = [];
            for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
              childRenderable = _ref6[_k];
  ...
  TYPO3.FormBuilder.View.ElementOptionsPanel = Ember.ContainerView.extend({
    ...
    onFormElementChange: (function() {
      var formFieldEditor, subView, subViewClass, subViewOptions, _k, _len2, _ref6, _results;
      this.removeAllChildren();
      if (!this.formElement) {
        return;
      }
      _ref6 = this.get('orderedFormFieldEditors');
      _results = [];
      for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
        formFieldEditor = _ref6[_k];
  ...
  TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.AbstractCollectionEditor = TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.AbstractPropertyEditor.extend({
    ...
    sortedAvailableCollectionElements: (function() {
      var collectionElementTemplate, identifier, sortedCollectionElements, _ref6;
    ...
    updateCollectionEditorViews: (function() {
      var availableCollectionElements, collection, collectionEditorViews, collectionElement, collectionElementEditor, collectionElementEditorOptions, collectionElementTemplate, i, _k, _len2;
    ...
    addRequiredCollectionElementsIfNeeded: function() {
      var availableCollectionElementTemplate, availableCollectionElements, collection, collectionElementName, identifier, requiredAndMissingCollectionElements, _k, _len2, _results;
      collection = this.get('value');
      availableCollectionElements = this.get('availableCollectionElements');
      ...
      _results = [];
      for (_k = 0, _len2 = requiredAndMissingCollectionElements.length; _k < _len2; _k++) {
    ...
    isCollectionElementTemplateFoundInCollection: function(collectionElementTemplateIdentifier) {
      var collection, collectionElement, _k, _len2;
      collection = this.get('value');
  ...
  TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.IdentifierEditor = TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.AbstractPropertyEditor.extend({
    ...
    validate: function(v) {
      ...
      findFormElementsWithIdentifiers = function(el) {
        var subRenderable, _k, _len2, _ref6, _results;
        if (el.get('identifier') === v) {
          elementsWithIdentifier.push(el);
        }
        _ref6 = el.get('renderables');
        _results = [];
        for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
          subRenderable = _ref6[_k];
  ...
  TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.SelectEditor = TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.AbstractPropertyEditor.extend({
    ...
    selectedValue: (function(k, v) {
      var element, _k, _len2, _ref6;
      if (arguments.length >= 2) {
        this.set('value', v.value);
        this.valueChanged();
      }
      _ref6 = this.get('availableElements');
      for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
        element = _ref6[_k];
  ...
  TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.PropertyGrid = TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.AbstractPropertyEditor.extend({
    ...
    columnDefinition: (function() {
      var column, columns, _k, _len2, _ref6;
      columns = [];
    ...
    buildTableRowModel: (function() {
      var defaultValue, isPreselected, originalRow, tableRowModel, v, _k, _l, _len2, _len3, _ref6, _results;
      ...
      _ref6 = this.get('value');
      _results = [];
      for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
        originalRow = _ref6[_k];
        isPreselected = false;
        for (_l = 0, _len3 = defaultValue.length; _l < _len3; _l++) {
          v = defaultValue[_l];
    ...
    valueChanged: function() {
      var defaultValue, i, oldDefaultValue, rows, tableRowModelRow, tmp, v, _k, _l, _len2, _len3, _ref6;
      rows = [];
      defaultValue = [];
      _ref6 = this.get('tableRowModel');
      for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
        tableRowModelRow = _ref6[_k];
      ...
      if (this.get('shouldShowPreselectedValueColumn') === 'multiple') {
        ...
        if (defaultValue.length === 0) {
          ...
          for (i = _l = 0, _len3 = defaultValue.length; _l < _len3; i = ++_l) {
            v = defaultValue[i];
    ...
    didInsertElement: function() {
      ...
      this.grid.onAddNewRow.subscribe((function(_this) {
        return function(e, args) {
          var columnDefinition, newItem, _k, _len2, _ref6;
          _this.grid.invalidateRow(_this.get('tableRowModel').length);
          newItem = {};
          _ref6 = _this.columns;
          for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
            columnDefinition = _ref6[_k];
      ...
      moveRowsPlugin.onBeforeMoveRows.subscribe(function(e, data) {
        var i, _k, _ref6;
        for (i = _k = 0, _ref6 = data.rows.length; 0 <= _ref6 ? _k < _ref6 : _k > _ref6; i = 0 <= _ref6 ? ++_k : --_k) {
  ...
  TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.FinisherEditor.EmailFinisherEditor = TYPO3.FormBuilder.View.ElementOptionsPanel.Editor.ValidatorEditor.DefaultValidatorEditor.extend({
    ...
    format: (function(k, v) {
      var chosenFormatKey, format, _k, _len2, _ref6;
      if (arguments.length >= 2) {
      ...
      _ref6 = this.get('availableFormats');
      for (_k = 0, _len2 = _ref6.length; _k < _len2; _k++) {
        format = _ref6[_k];
